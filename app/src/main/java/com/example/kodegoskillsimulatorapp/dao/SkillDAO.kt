...
class SkillDAOSQLImpl(var context: Context): SkillDAO {
    ...
    override fun addSkill(skill: Skill) {
        ...
        contentValues.put(DatabaseHandler.skillType, defaultType)
    ...
    override fun getIcon(cursor: Cursor, columnIndex: Int, skill: Skill) {
