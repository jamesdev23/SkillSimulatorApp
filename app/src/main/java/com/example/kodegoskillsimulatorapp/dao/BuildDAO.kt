...
class BuildDAOSQLImpl(var context: Context): BuildDAO {
    ...
    override fun getBuildByName(buildName: String): Build {
        val databaseHandler: DatabaseHandler = DatabaseHandler(context)
